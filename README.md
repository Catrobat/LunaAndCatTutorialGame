...
## Work Done 
 ...
 _Every [commit](https://github.com/Catrobat/LunaAndCatTutorialGame/commits/master) is the individual's work, except stating otherwise in the title of the commit_
...
by [Stefania Maks](https://github.com/stefaniamak). [Stefania Maks](https://github.com/stefaniamak) code is responsible for the feature that ensures
