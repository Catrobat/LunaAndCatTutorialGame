...
The learning mechanism of this game is based on Cognitive Load Theory. The examples of code shown to the user by Cat are worked examples. Worked examples are completed examples of a problem. For example, a line by line solution of an algebra problem is a worked example.
